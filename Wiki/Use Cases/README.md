...
This document provides detailed examples of how Repl solves specific API security testing challenges.
...
The collection includes pre-request scripts that generate AWS SigV4 signatures, and Repl preserves these signatures in the requests sent to Burp Suite.
